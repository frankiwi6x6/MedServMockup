...
import CreateRequestModal from '../../components/CreateRequestComponent/CreateRequestModal';
import AITechnicianChatComponent from '../../components/AITechnicianChatComponent/AITechnicianChatComponent';
import ChatToggleButton from '../../components/AITechnicianChatComponent/ChatToggleButton';
    ...
    <div className='relative'>
      <div className='bg-[#EFEFEF] h-screen'>
        <div className='flex py-7 px-11 justify-between'>
          ...
          <div className='w-6/12 bg-[#D9D9D9] min-h-[700px] rounded-lg'>
            <h1 className='text-4xl text-black font-bold pl-10 mt-7 '>
      ...
      <AITechnicianChatComponent isOpen={isChatOpen} onClose={toggleChat} />
    </div>
  );
}
